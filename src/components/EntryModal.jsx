...
//                     <div
//                         className="flex flex-col items-center border rounded-xl p-4 text-center hover:shadow-md hover:border-blue-400 transition cursor-pointer"
...
//                     <div
//                         className="flex flex-col items-center border rounded-xl p-4 text-center bg-lime-50 hover:shadow-md hover:border-lime-400 transition cursor-pointer"
//                         onClick={() => setPanelVisible(true)}
//                     >
//                         <div className="text-2xl mb-2">✨</div>
...
//                         <button className="w-8 h-8 rounded-full bg-lime-600 text-white flex items-center justify-center hover:bg-lime-700"
//                         >
//                             ➝
//                         </button>
